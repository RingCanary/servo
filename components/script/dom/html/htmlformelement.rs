...
impl HTMLFormElementMethods<crate::DomTypeHolder> for HTMLFormElement {
    ...
    fn SupportedPropertyNames(&self) -> Vec<DOMString> {
        ...
        // Track seen names in a HashSet to reduce deduplication lookup from O(N) to O(1),
        // preventing an overall O(N^2) complexity on collections with many named items.
