...
impl HTMLFormElementMethods<crate::DomTypeHolder> for HTMLFormElement {
    ...
    fn SupportedPropertyNames(&self) -> Vec<DOMString> {
        ...
        // Step 6
        // Optimization: Avoid allocating a string with .to_string() just to check if it's empty.
        sourced_names_vec.retain(|sn| !sn.name.is_empty());

        // Step 7-8
        // Optimization: Use a HashSet to track seen names, preventing O(N^2) array scans.
